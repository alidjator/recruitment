Berikut adalah detail pengembangan draf soal *Technical Test* untuk kandidat *Java Spring Boot Developer* tingkat *Medium*, yang disusun mengikuti struktur dan format dari dokumen aslinya. Penambahan untuk tingkat medium ditekankan pada implementasi keamanan lanjutan (JWT), struktur arsitektur (DTO, Exception Handling), efisiensi data (Pagination, Soft Delete), dan pengujian otomatis (Unit Testing).

---

**PT. PRAWATHIYA KARSA PRADIPTHA | TECHNICAL ASSESSMENT**

* **Document No.** : PKP-TNT-TA-002-MED (Diperbarui dari versi V1.0)
* **Revision** : 02
* **Classification** : CONFIDENTIAL


* **Output** : Java Spring Boot Project (zip)


* **Test Type** : Practical Coding Test
...
1. Waktu pengerjaan maksimal Kamis, 30 Juli 2026 pukul 10.00 *(Dapat disesuaikan dengan jadwal kandidat)*.
...
Catatan: Hanya submission yang dikirim melalui Google Form yang akan diproses dalam tahap evaluasi.