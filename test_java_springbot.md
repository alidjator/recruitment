...
1. Gunakan framework Spring Boot.


2. Implementasi harus menggunakan logic dan pemahaman pribadi kandidat. Menerapkan *SOLID principles* dan *Clean Code* akan menjadi nilai tambah.


3. Tidak diperbolehkan menggunakan starter, template, atau library yang secara langsung menyediakan fitur authentication siap pakai tanpa implementasi kandidat, seperti:
...
4. Kandidat diperbolehkan menggunakan dokumentasi resmi sebagai referensi.


5. Pastikan project dapat dijalankan dan diuji setelah selesai.


6. Prioritaskan functionality, code structure, clean code, dan best practice.
