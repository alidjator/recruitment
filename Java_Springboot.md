...
**Gunakan** *Global Exception Handler* (`@ControllerAdvice`) untuk menangkap error validasi dan mereturn *Response JSON* dengan format baku (misal: memunculkan `message`, `status`, dan detail error validasi).
